...
CLASSES = ('background', 'left ventricular myocardium', 'left atrial cavity', 'left ventricular cavity', 'right atrial cavity', 'right ventricular cavity', 'ascending aorta', 'arterial')
PALETTE = [[0, 0, 0], [61, 61, 61], [126, 126, 126], [150, 150, 150], [165, 165, 165], [180, 180, 180], [246, 246, 246], [255, 255, 255]]
...
class mmwhsDataset(Dataset):
    def __init__(self, data_root='data/mmwhs/train', mode='train', img_dir='train_images', mask_dir='train_masks_convert',
